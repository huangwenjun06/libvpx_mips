...
static __inline void vp8_mbfilter_simd
(
    uint32_t mask,
    uint32_t hev,
    uint32_t *op2,
...
void vp8_loop_filter_mbh_simd(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr,
...
void vp8_loop_filter_mbv_simd(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr,
                               int y_stride, int uv_stride, loop_filter_info *lfi)
{
...
void vp8_loop_filter_bh_simd(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr,
                              int y_stride, int uv_stride, loop_filter_info *lfi)
{
...
void vp8_loop_filter_bv_simd(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr,
                              int y_stride, int uv_stride, loop_filter_info *lfi)
{
