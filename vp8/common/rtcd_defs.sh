...
specialize vp8_dequant_idct_add mmx media neon dspr2 simd
...
specialize vp8_dequant_idct_add_y_block mmx sse2 media neon dspr2 simd
...
specialize vp8_loop_filter_mbv mmx sse2 media neon dspr2 simd
...
specialize vp8_loop_filter_bv mmx sse2 media neon dspr2 simd
...
specialize vp8_loop_filter_mbh mmx sse2 media neon dspr2 simd
...
specialize vp8_loop_filter_bh mmx sse2 media neon dspr2 simd
...
specialize vp8_loop_filter_simple_mbv mmx sse2 media neon simd
...
specialize vp8_loop_filter_simple_mbh mmx sse2 media neon simd
...
specialize vp8_loop_filter_simple_bv mmx sse2 media neon simd
...
specialize vp8_loop_filter_simple_bh mmx sse2 media neon simd
...
specialize vp8_short_idct4x4llm mmx media neon dspr2 simd
...
vp8_short_inv_walsh4x4_1=vp8_short_inv_walsh4x4_1_simd	#no mmx
#vp8_short_inv_walsh4x4_1_simd=vp8_short_inv_walsh4x4_1_simd	#no mmx
# no asm yet

#iwalsh16
prototype void vp8_short_inv_walsh4x4 "short *input, short *output"
specialize vp8_short_inv_walsh4x4 mmx sse2 media neon dspr2 simd
...
specialize vp8_dc_only_idct_add	mmx media neon dspr2 simd
...
specialize vp8_copy_mem16x16 mmx sse2 media neon dspr2 simd
vp8_copy_mem16x16_media=vp8_copy_mem16x16_v6
vp8_copy_mem16x16_dspr2=vp8_copy_mem16x16_dspr2

prototype void vp8_copy_mem8x8 "unsigned char *src, int src_pitch, unsigned char *dst, int dst_pitch"
specialize vp8_copy_mem8x8 mmx media neon dspr2 simd
...
specialize vp8_copy_mem8x4 mmx media neon dspr2 simd
...
specialize vp8_build_intra_predictors_mby_s sse2 ssse3 simd
...
specialize vp8_build_intra_predictors_mbuv_s sse2 ssse3 simd
...
if [ "$CONFIG_POSTPROC" = "yes" ]; then
    ...
    specialize vp8_mbpost_proc_down mmx sse2 simd
    ...
    specialize vp8_mbpost_proc_across_ip sse2 simd
    ...
    specialize vp8_post_proc_down_and_across_mb_row sse2 simd
    ...
    specialize vp8_plane_add_noise mmx sse2 simd
...
specialize vp8_sixtap_predict16x16 mmx sse2 ssse3 media neon dspr2 simd
vp8_sixtap_predict16x16_media=vp8_sixtap_predict16x16_armv6
vp8_sixtap_predict16x16_dspr2=vp8_sixtap_predict16x16_dspr2
vp8_sixtap_predict16x16=vp8_sixtap_predict16x16_simd
#vp8_sixtap_predict16x16_simd=vp8_sixtap_predict16x16_simd

prototype void vp8_sixtap_predict8x8 "unsigned char *src, int src_pitch, int xofst, int yofst, unsigned char *dst, int dst_pitch"
specialize vp8_sixtap_predict8x8 mmx sse2 ssse3 media neon dspr2 simd
...
specialize vp8_sixtap_predict8x4 mmx sse2 ssse3 media neon dspr2 simd
...
specialize vp8_sixtap_predict4x4 mmx ssse3 media neon dspr2 simd
...
specialize vp8_bilinear_predict16x16 mmx sse2 ssse3 media neon simd
...
specialize vp8_bilinear_predict8x8 mmx sse2 ssse3 media neon simd
...
specialize vp8_bilinear_predict8x4 mmx media neon simd
...
specialize vp8_bilinear_predict4x4 mmx media neon simd
...
specialize vp8_variance4x4 mmx sse2 simd
...
specialize vp8_variance8x8 mmx sse2 media neon simd
...
specialize vp8_variance8x16 mmx sse2 neon simd
...
specialize vp8_variance16x8 mmx sse2 neon simd
...
specialize vp8_variance16x16 mmx sse2 media neon simd
...
specialize vp8_sub_pixel_variance4x4 mmx sse2 simd
...
specialize vp8_sub_pixel_variance8x8 mmx sse2 media neon simd
...
specialize vp8_sub_pixel_variance8x16 mmx sse2 simd
...
specialize vp8_sub_pixel_variance16x8 mmx sse2 ssse3 simd
...
specialize vp8_sub_pixel_variance16x16 mmx sse2 ssse3 media neon simd
...
specialize vp8_variance_halfpixvar16x16_h mmx sse2 media neon simd
...
specialize vp8_variance_halfpixvar16x16_v mmx sse2 media neon simd
...
specialize vp8_variance_halfpixvar16x16_hv mmx sse2 media neon simd
...
specialize vp8_sad4x4 mmx sse2 neon simd
...
specialize vp8_sad8x8 mmx sse2 neon simd
...
specialize vp8_sad8x16 mmx sse2 neon simd
...
specialize vp8_sad16x16 mmx sse2 sse3 media neon simd
...
specialize vp8_get_mb_ss mmx sse2 simd
...
specialize vp8_sub_pixel_mse16x16 mmx sse2 simd
...
specialize vp8_mse16x16 mmx sse2 media neon simd
...
specialize vp8_get4x4sse_cs mmx neon simd
